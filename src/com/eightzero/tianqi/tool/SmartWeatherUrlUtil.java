...
/**
 * JAVA版。 调用方法：String apiUrl=SmartWeatherUrlUtil.getInterfaceURL(城市编号,数据类型);
 */
public class SmartWeatherUrlUtil {
	...
	//天气数据接口申请的 APP_ID
	private static final String APP_ID = "51be743cf63ded42";
	//天气数据接口申请的 PRIVATE_KEY
	private static final String PRIVATE_KEY = "91e87c_SmartWeatherAPI_017fb39";
	//天气数据接口地址
	private static final String WEATHER_IP = "http://open.weather.com.cn/data/?";
	...
	private static String getInterfaceURL(String areaid, String type,
		...
		String keyurl = WEATHER_IP + "areaid=" + areaid + "&type=" + type + "&date=" + date + "&appid=";
		String key = getKey(keyurl + APP_ID, PRIVATE_KEY);
		System.out.println("加密后的+++++++++++++++++++++++++++"+key);
		String appid6 = APP_ID.substring(0, 6);
